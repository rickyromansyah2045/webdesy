                    ...
                    <div class="dropdown-menu dropdown-menu-right border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownUserImage">
                        <h6 class="dropdown-header d-flex align-items-center">
                            ...
                            <div class="dropdown-user-details">
                                <div class="dropdown-user-details-name"><?= session('name')?></div>
                        ...
                        <a class="dropdown-item" href="<?= base_url()?>/xlogin/do_logout">
                ...
                <nav class="sidenav shadow-right sidenav-light">
                        ...
                        <div class="nav accordion" id="accordionSidenav">
                            ...
                            <div class="collapse" id="collapseDashboards" data-parent="#accordionSidenav">
                                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                                    ...
                                    <!-- </a>
                                    <a class="nav-link" href="dashboard-2.html">Blogs</a>
                                </nav>
                            </div> -->
                            <a class="nav-link" href="<?= base_url() ?>/xdashboard">
                                <div class="nav-link-icon"><i data-feather="bar-chart"></i></div>
                                Dashboard
                            </a>
                            <!-- Sidenav Link (Tables)-->
                            <a class="nav-link active" href="<?= base_url() ?>/blogs">
                    ...
                    <div class="sidenav-footer">
                        <div class="sidenav-footer-content">
                            ...
                            <div class="sidenav-footer-title"><?= session('name');?></div>
                        </div>
                    </div>
                </nav>
            </div>
                            ...
                            <div class="page-header-content pt-4">
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-auto mt-4">
                                        ...
                                        <div class="page-header-subtitle">Ciptakan karyamu, sekarang!</div>
                                    </div>
                                ...
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="mr-3">
                                                <div class="text-white-75 small">Total Blog</div>
                                                <div class="text-lg font-weight-bold">100</div>
                                            </div>
                                            <i class="feather-xl text-white-50" data-feather="calendar"></i>
                                        </div>
                                    </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between" style="border: 0;background-color: #0061f2;">
                            ...
                            <div class="col-xxl-3 col-lg-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="mr-3">
                                                <div class="text-white-75 small">Blog Tayang</div>
                                                <div class="text-lg font-weight-bold">50</div>
                                            </div>
                                            <i class="feather-xl text-white-50" data-feather="check-square"></i>
                                        </div>
                                    </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between" style="border: 0;background-color: #f4a100;">
                                        <!-- <a class="small text-white stretched-link" href="#">View Report</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div> -->
                                    </div>
                                </div>
                            ...
                            <div class="col-xxl-3 col-lg-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="mr-3">
                                                <div class="text-white-75 small">Arsip Blog</div>
                                                <div class="text-lg font-weight-bold">17</div>
                                            </div>
                                            <i class="feather-xl text-white-50" data-feather="message-circle"></i>
                                        </div>
                                    </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between" style="border: 0;background-color: #e81500;">
